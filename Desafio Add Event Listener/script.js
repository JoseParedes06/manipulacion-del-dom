...
const emojiInput = document.getElementById('emjiInput');
...
function changeEmoji() {
    ...
    emojiResult.innerHTML = emojiPickl;
}

// MouseOver

const resetBtn = document.getElementById('reset');
const pipesHitBox = document.getElementById('.pipeHitBox');
const message = document.getElementById('message');
const dieCount = document.getElementById('dieCount');

// Agrego AddEventListener a las pipes
